    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        blank=True, max_length=300, upload_to=titles.models.image_path
                    ),
                ),
                (
                    "thumbnail",
                    models.ImageField(
                        blank=True,
                        max_length=300,
                        upload_to=titles.models.image_thumb_path,
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="%(class)s", to="titles.Genre"
                    ),
                ),
                (
                    "image",
                ...
                (
                    "magazine",
                    models.ManyToManyField(
                        blank=True, related_name="manga", to="titles.Magazine"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="manga", to="titles.Publisher"
            ),
        ),
        migrations.AddField(
            model_name="manga",
            name="related_post",
            field=models.ManyToManyField(
                blank=True, related_name="%(class)s", to="post.Post"
            ),
        ),
        migrations.AddField(
            model_name="manga",
            name="theme",
            field=models.ManyToManyField(
                blank=True, related_name="%(class)s", to="titles.Theme"
            ),
        ),
        migrations.AddField(
            model_name="manga",
        ...
        migrations.AddField(
            ...
            name="studio",
            field=models.ManyToManyField(
                blank=True, related_name="anime", to="titles.Studio"
            ),
        ),
        migrations.AddField(
            model_name="anime",
