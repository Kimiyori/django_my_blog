...
class SequelPrequelAnime(models.Model):
    sequel = models.ForeignKey(
        "Anime", on_delete=models.CASCADE, related_name="prequel", null=True, blank=True
    )
    prequel = models.ForeignKey(
        "Anime", on_delete=models.CASCADE, related_name="sequel", null=True, blank=True
    )


class SequelPrequelManga(models.Model):
    sequel = models.ForeignKey(
        "Manga", on_delete=models.CASCADE, related_name="prequel", null=True, blank=True
    )
    prequel = models.ForeignKey(
        "Manga", on_delete=models.CASCADE, related_name="sequel", null=True, blank=True
    )
...
class MetaTitle(models.Model):
    ...
    title = models.ForeignKey(
        Title, on_delete=models.CASCADE, related_name="%(class)s", null=True
    )
    premiere = models.DateField(null=True, blank=True)
    genre = models.ManyToManyField(Genre, related_name="%(class)s", blank=True)
    theme = models.ManyToManyField(Theme, related_name="%(class)s", blank=True)
    ...
    urls = models.ForeignKey(
        Urls, on_delete=models.SET_NULL, related_name="%(class)s", blank=True, null=True
    )
...
class Manga(MetaTitle):
    ...
    publisher = models.ManyToManyField(Publisher, related_name="manga", blank=True)
    ...
    magazine = models.ManyToManyField(Magazine, related_name="manga", blank=True)
...
class Anime(MetaTitle):
    type = models.ForeignKey(
        AnimeType, on_delete=models.CASCADE, related_name="anime", null=True, blank=True
    )
    studio = models.ManyToManyField(Studio, related_name="anime", blank=True)
