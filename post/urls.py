...
urlpatterns = [
    ...
    path("<uuid:pk>/delete/", PostDelete.as_view(), name="post_delete"),
    path("create/", PostCreate.as_view(), name="post_detail_create"),
    path(
        "<uuid:post_id>/content/create/<model_name>",
        ContentCreateUpdateView.as_view(),
        name="module_content_create",
    ),
    path(
        "<uuid:post_id>/content/create/<model_name>/<order>",
        ContentCreateUpdateView.as_view(),
        name="module_content_create",
    ),
    path(
        "<uuid:post_id>/content/<model_name>/<id>/",
        ContentCreateUpdateView.as_view(),
        name="module_content_update",
    ),
    path(
        "content/<uuid:post_id>/<int:id>/delete/",
